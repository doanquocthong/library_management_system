    ...
    <header className="bg-white shadow sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          <img src="/images/logo-uth.png" alt="UTH Logo" className="h-24 w-auto" />
        ...
        <div className="flex items-center gap-10">
          <nav className="flex items-center gap-6 text-sm font-medium text-gray-700">
            ...
            <Link href="/introduce" className="text-sm text-black px-3 py-1 rounded hover:bg-gray-200 hover:text-indigo-700 transition">
              Giới thiệu
            </Link>
            <Link href="/contact" className="text-sm text-black px-3 py-1 rounded hover:bg-gray-200 hover:text-indigo-700 transition">
              Liên hệ
            </Link>
          </nav>
          ...
          {user ? (
            ...
            <div className="space-x-3">
              ...
              <Link href="/sign-up" className="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium py-1.5 px-4 rounded-lg transition">
                Đăng ký
              </Link>
            </div>
          )}
