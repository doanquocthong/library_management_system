    ...
    <aside className="w-64 bg-white shadow-lg flex flex-col h-screen sticky top-0 z-10">
      ...
      <nav className="flex-1 px-4 py-4 overflow-y-auto text-sm">
        ...
        <ul className="space-y-2">
          <li><Link href="#" className="flex items-center gap-2 p-2 rounded-lg hover:bg-indigo-100"><Layers className="w-4" /> Tổng quan</Link></li>
          ...
          <li><Link href="#" className="flex items-center gap-2 p-2 rounded-lg hover:bg-indigo-100"><Database className="w-4" /> Tài liệu số</Link></li>
